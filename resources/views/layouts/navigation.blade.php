<nav x-data="{ open: false }" class="bg-indigo-200 border-b border-gray-500 rounded-b-lg">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900">Registro</a>
                    @endif
                @endauth
            </div>
